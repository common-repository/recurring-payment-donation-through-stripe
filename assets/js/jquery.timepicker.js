...
(function (factory) {
	...
	function _render(self)
	{
		...
		for (var i=start, j=0; i <= end; j++, i += stepFunc(j)*60) {
			...
			var timeString2 = _int2time(timeInt2, settings);
			var dt = new Date();
			...
			if (settings.useSelect) {
				...
				var data1 = _int2time ((timeInt <= 86400 ? timeInt : timeInt % 86400), settings);
				var data2 = _int2time ((timeInt2 <= 86400 ? timeInt2 : timeInt2 % 86400), settings);
				var string_date = data1 + ' - '+ data2;
				row.data('time', string_date);
				row.text(timeString +" - "+ timeString2);
			}
